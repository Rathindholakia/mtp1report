...
\caption{SIC block Diagram \cite{Paper:fssmanual}}
\label{fig:SIC}
\end{figure}
...
\caption{IIRC card Block Diagram \cite{Paper:fssmanual}}
\label{fig:IIRC}
\end{figure}
...
\caption{CPU card Block Diagram \cite{Paper:fssmanual}}
\label{fig:cpu}
\end{figure}
